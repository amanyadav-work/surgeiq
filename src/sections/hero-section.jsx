...
import TiltedImage from "@/components/ui/tilt-image";
    ...
    return (
        <section className="flex flex-col items-center -mt-18">
            ...
            <motion.p
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Access top-notch healthcare services, manage your appointments, and stay on track with your well-being — all in one place.
            </motion.p>
